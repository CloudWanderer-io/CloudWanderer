...
class CloudWandererResourcesDirective(SphinxDirective):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.aws_interface = cloudwanderer.aws_interface.CloudWandererAWSInterface(boto3_session=self.boto3_session)
    ...
    def get_boto3_default_services(self) -> list:
        ...
        for service_name in boto3_services:
            resource_collections = get_resource_collections(self.boto3_session.resource(service_name))
    ...
    def get_cloudwanderer_resources(self) -> list:
        ...
        cloudwanderer_services = self.aws_interface.boto3_getter.custom_resource_definitions.services
        for service_name, service in sorted(cloudwanderer_services.items()):
            ...
            resource_collections = get_resource_collections(service)
            for resource_collection in resource_collections:
...
class CloudWandererSecondaryAttributesDirective(SphinxDirective):
    ...
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self.aws_interface = cloudwanderer.aws_interface.CloudWandererAWSInterface(
    ...
    def get_cloudwanderer_secondary_attributes(self) -> list:
        ...
        for boto3_service in self.aws_interface.boto3_getter.custom_resource_definitions.get_all_resource_services():
            for collection in get_resource_collections(boto3_service):
                service_model = boto3_service.meta.client.meta.service_model
                service_name = service_model.metadata["serviceId"]
                resource_list = nodes.bullet_list()
                secondary_attributes = self.aws_interface.boto3_getter.get_child_resource_definitions(
...
class GetCwServices:
    ...
    def get_cloudwanderer_services(self) -> list:
        boto3_services = sorted(
            self.aws_interface.boto3_getter.custom_resource_definitions.get_all_resource_services(),
    ...
    def get_collections(self, boto3_service: boto3.resources.base.ServiceResource) -> list:
        ...
        result = []
        collections = sorted(get_resource_collections(boto3_service), key=lambda x: x.resource.model.name)
    ...
    def get_subresources(
        self, boto3_service: boto3.resources.base.ServiceResource, boto3_resource: boto3.resources.model.ResourceModel
    ) -> str:
        result = ""
        service_name = boto3_service.meta.resource_model.name
        parent_resource_name = xform_name(boto3_resource.name)
        subresources = self.aws_interface.boto3_getter.get_child_resource_definitions(
    ...
    def get_secondary_attributes(
        ...
        service_name = boto3_service.meta.resource_model.name
        parent_resource_name = xform_name(boto3_resource.name)
        secondaryAttributes = self.aws_interface.boto3_getter.get_child_resource_definitions(
