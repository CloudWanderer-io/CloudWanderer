...
class TestStorageConnectorDynamoDb(unittest.TestCase):
    ...
    def test_write_and_read_resource(self):
        urn = generate_urn(service='ec2', resource_type='instances', id=self.ec2_instances[0].instance_id)
        ...
        result_resource_of_type = next(self.connector.read_resource_of_type('ec2', 'instances'))
